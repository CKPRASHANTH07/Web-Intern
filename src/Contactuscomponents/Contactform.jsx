  ...
  return (
    ...
    <div className='mx-32'>
      <div className="mx-auto mt-20 text-center max-w-2x">
        <h1 className="text-xl text-transparent font-Poppins bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text sm:text-4xl">Contact sales</h1>
      </div>
    ...
    <h1 className='text-2xl text-center font-Poppins'>Our Team will reach you in mins</h1>
     ...
     <div className='flex flex-col px-5 py-5 shadow-lg gap-y-5 rounded-xl bg-violet-500'>
      ...
      <p className='text-lg font-bold text-center text-white font-Inter'>Print  Majesty Pvt. Ltd.Ground Floor, Plot No. 105,Marol Co – op Industrial Estate,Mathuradas Vasanji Road, Marol,Andheri East, Mumbai – 400 059.
      </p>
     </div>
   </div>
   </div>
